...
def main() -> None:
    ...
    print("Training Random Forest 1:50...")
    model.fit(
        x_train,
        y_train,
    )
    ...
    for top_pct in TOP_PCTS:
        ...
        drive_recall = len(positive_alerted_drives) / len(positive_drives)
        ...
        results.append(
            {
                ...
                "detected_positive_drives": len(positive_alerted_drives),
    ...
    print("\nRandom Forest operational validation results:")
